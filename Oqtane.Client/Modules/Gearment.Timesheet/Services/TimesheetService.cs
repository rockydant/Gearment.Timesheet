...
namespace Gearment.Timesheet.Services
{
    public class TimesheetService : ServiceBase, ITimesheetService, IService
    {
        ...
        public async Task<List<Models.PayrollViewModel>> GetPayrollDataAsync(int ModuleId, TimesheetDailyQuery TimesheetDailyQuery)
        {
            return await PostJsonAsync<TimesheetDailyQuery, List<Models.PayrollViewModel>>(CreateAuthorizationPolicyUrl($"{Apiurl}/payroll/", ModuleId), TimesheetDailyQuery);
        }
        ...
        public async Task<Models.Employee_FaceRegEvent> AddAttendanceDataAsync(Models.Employee_FaceRegEvent eventDetail, int ModuleId)
        {
        ...
        public async Task<Models.Employee_FaceReg> GetEmployeeFaceByIdAsync(string employeeID, int ModuleId)
        {
            return await GetJsonAsync<Models.Employee_FaceReg>(CreateAuthorizationPolicyUrl($"{Apiurl}/attendance/employee/{employeeID}", ModuleId));
        }
    }
}
